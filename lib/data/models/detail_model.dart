class DetailModel {
  ...
  @override
  String toString() {
    return 'DetailModel{type: $type, sequence: $sequence, productId: $productId, price: $price, open24h: $open24h, volume24h: $volume24h, low24h: $low24h, high24h: $high24h, volume30d: $volume30d, bestBid: $bestBid, bestBidSize: $bestBidSize, bestAsk: $bestAsk, bestAskSize: $bestAskSize, side: $side, time: $time, tradeId: $tradeId, lastSize: $lastSize}';
  }
}
